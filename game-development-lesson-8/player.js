...
export default class Player {
    constructor(gameWidth, gameHeight) {
        ...
        this.vy = 0; // pull player upwards
        this.weight = 0.5; // pull player downwards
        this.frameX = 0;
        this.frameY = 0;
        this.maxFrame = 6; // we start with standing animation which has 6 frames, everytime we enter a new state we change the value of maxFrame
        this.speed = 0;
        this.maxSpeed = 10;
        // timing things with deltaTime needs 3 helper variables:
        this.fps = 30;
        this.frameTimer = 0;
