window.addEventListener('load', function () {
    ...
    class InputHandler {
        constructor() {
            this.keys = [];
            this.touchY = ''; // it will store the initial start vertical coordinate
    ...
    class Player {
        ...
        update(input, deltaTime, enemies) {
            ...
            // set boundaries (player cannot move out of the game board)
            ...
            if (!this.onGround()) {
                this.vy += this.weight;
                this.maxFrame = 5; // jumping sprite has only 5 frames 
                this.frameY = 1;
            }
            else {
                this.vy = 0;
                this.maxFrame = 8; // running sprite has 8 frames
                this.frameY = 0;
            }
    ...
    function displayStatusText(ctx) {
        ...
        if (gameOver) {
            ...
            ctx.fillStyle = 'white';
            ctx.fillText('GAME OVER, press Enter or swipe down to restart!', canvas.width / 2 + 2, 202);
        }
    }
